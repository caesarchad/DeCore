...
impl ErasureMetaColumn {
    pub fn new(set_index: u64) -> ErasureMetaColumn {
        ErasureMetaColumn {
            set_index,
            size: 0,
            data: 0,
...
fn test_meta_indexes() {
    ...
    for _ in 0..100 {
        ...
        assert_eq!(set_index, ErasureMetaColumn::set_index_for(blob_index));
        let e_meta = ErasureMetaColumn::new(set_index);
    ...
    let mut e_meta = ErasureMetaColumn::new(0);
...
fn test_meta_coding_present() {
    ...
    e_meta.set_index = ErasureMetaColumn::set_index_for((NUM_DATA * 17) as u64);
...
fn test_meta_data_present() {
    ...
    e_meta.set_index = ErasureMetaColumn::set_index_for((NUM_DATA * 23) as u64);
    let start_idx = e_meta.start_index();
