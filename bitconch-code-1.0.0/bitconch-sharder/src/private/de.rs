    ...
    E: Error,
{
        ...
        E: Error,
    {
        ...
        fn de_whatever<V>(self, _visitor: V) -> Result<V::Value, E>
        where
            V: Visitor<'de>,
        {
        ...
        fn de_selection<V>(self, visitor: V) -> Result<V::Value, E>
        where
            V: Visitor<'de>,
        {
            visitor.visit_none()
    ...
    D: Deserializer<'de>,
{
    ...
    deserializer.de_string(CowStrVisitor)
}
    ...
    D: Deserializer<'de>,
{
    ...
    deserializer.de_octets(CowBytesVisitor)
}
...
mod content {
    ...
    impl<'de> Deserialize<'de> for Content<'de> {
            ...
            D: Deserializer<'de>,
        {
            ...
            deserializer.de_whatever(visitor)
        }
    }
        ...
        E: de::Error,
    {
        ...
        fn de_pair<V>(self, _len: usize, visitor: V) -> Result<V::Value, Self::Error>
        where
            V: Visitor<'de>,
        {
            self.de_sequence(visitor)
        }
        ...
        E: de::Error,
    {
        ...
        fn module_variable(self) -> Result<(), E> {
            match self.value {
        ...
        fn newtype_variable_source<T>(self, seed: T) -> Result<T::Value, E>
        where
        ...
        fn pair_variable<V>(self, _len: usize, visitor: V) -> Result<V::Value, Self::Error>
        where
            V: de::Visitor<'de>,
        {
            match self.value {
                Some(Content::Seq(v)) => {
                    de::Deserializer::de_whatever(SeqDeserializer::new(v), visitor)
                }
            ...
            V: de::Visitor<'de>,
        {
            match self.value {
                Some(Content::Map(v)) => {
                    de::Deserializer::de_whatever(MapDeserializer::new(v), visitor)
                }
                Some(Content::Seq(v)) => {
                    de::Deserializer::de_whatever(SeqDeserializer::new(v), visitor)
                }
        ...
        E: de::Error,
    {
        ...
        #[inline]
        fn de_whatever<V>(mut self, visitor: V) -> Result<V::Value, Self::Error>
        where
            V: de::Visitor<'de>,
        {
        ...
        E: de::Error,
    {
        ...
        fn de_whatever<V>(self, visitor: V) -> Result<V::Value, E>
        where
            V: Visitor<'de>,
        {
            match *self.content {
        ...
        where
            V: Visitor<'de>,
        {
            self.de_module(visitor)
        }

        fn de_newtype_struct<V>(self, _name: &str, visitor: V) -> Result<V::Value, E>
        where
            V: Visitor<'de>,
        {
            match *self.content {
            ...
            V: de::Visitor<'de>,
        {
            match self.value {
                Some(&Content::Seq(ref v)) => {
                    de::Deserializer::de_whatever(SeqRefDeserializer::new(v), visitor)
                }
                Some(other) => Err(de::Error::invalid_type(
                    other.unexpected(),
                    &"tuple variant",
            ...
            V: de::Visitor<'de>,
        {
            match self.value {
                Some(&Content::Map(ref v)) => {
                    de::Deserializer::de_whatever(MapRefDeserializer::new(v), visitor)
                }
                Some(&Content::Seq(ref v)) => {
                    de::Deserializer::de_whatever(SeqRefDeserializer::new(v), visitor)
                }
...
/// A DeserializeSeed helper for implementing de_in_preparation Visitors.
///
/// Wraps a mutable reference and calls de_in_preparation on it.
    ...
    T: Deserialize<'de>,
{
    ...
    where
        D: Deserializer<'de>,
    {
        T::de_in_preparation(deserializer, self.0)
    }
}
    ...
    E: Error,
{
    ...
    fn de_newtype_struct<V>(self, _name: &str, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
    {
    ...
    forward_to_deserialize_other! {
        ...
        de_octet_buffer()
        de_module()
        de_module_struct(&'static str)
        de_sequence()
        de_pair(usize)
        de_pair_struct(&'static str, usize)
        de_id()
        de_neglected_whatever()
    }
}
